...
object TasteTagTaxonomy {
    ...
    val GENRE_TAGS: Set<String> = setOf(
        ...
        // 游戏
        "游戏", "网游", "电子游戏",
        // 补充：常见主流题材 / 情绪（用户反馈全部作品池标签偏少，扩充白名单让更多热门题材可选）
        "萌系", "日常向", "废萌", "百合向", "群像剧", "治愈向", "热血向",
        "奇幻冒险", "校园恋爱", "恋爱喜剧", "后宫harem", "轻百合",
        "科幻冒险", "异世界转生", "穿越时空", "超自然", "灵异", "克苏鲁",
        "西幻", "东方奇幻", "剑与魔法", "蒸汽朋克", "赛博朋克", "废土末世",
        "校园日常", "青春校园", "职场恋爱", "成人向恋爱",
        "音乐番", "偶像番", "乐队番", "舞台", "声乐",
        "料理美食", "美食番", "旅行冒险", "公路片",
        "机器人动画", "巨大机器人", "驾驶舱", "近未来", "架空世界", "架空历史",
        "推理悬疑", "本格推理", "社会派", "硬汉", "黑色幽默", "讽刺",
        "治愈日常", "温情", "感人", "泪腺崩坏", "破防", "上头",
        "战斗番", "格斗番", "热血战斗", "超燃", "神展开",
        "废柴逆袭", "扮猪吃虎", "开挂", "系统流", "无敌流",
        "萌宠", "拟人", "拟人化", "萌娘", "反差萌", "傲娇", "病娇", "天然呆", "元气",
        "催泪弹", "深夜致郁", "细思极恐", "反乌托邦", "反战",
    )
}
